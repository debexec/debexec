...
debexec_$(VERSION)_amd64.deb: debexec/DEBIAN/control debexec/usr/bin debexec/usr/share/debexec/bin debexec/usr/share/debexec/lib debexec/usr/share/debexec/scripts
