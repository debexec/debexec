...
echo "custatus:1:11.1111:Installing gcc..." >/REAL_ROOT/${DEBEXEC_APTFIFO}
...
echo "custatus:2:22.2222:Installing core C libraries..." >/REAL_ROOT/${DEBEXEC_APTFIFO}
...
echo "custatus:3:33.3333:Unpacking core Unix utilities..." >/REAL_ROOT/${DEBEXEC_APTFIFO}
...
echo "custatus:4:44.4444:Installing core Unix utilities..." >/REAL_ROOT/${DEBEXEC_APTFIFO}
install_deps --and-package coreutils debianutils dpkg
echo "custatus:5:55.5555:Installing core Unix utilities..." >/REAL_ROOT/${DEBEXEC_APTFIFO}
install_deps dash
echo "custatus:6:66.6666:Installing core Unix utilities..." >/REAL_ROOT/${DEBEXEC_APTFIFO}
...
echo "custatus:7:77.7777:Installing core Unix utilities..." >/REAL_ROOT/${DEBEXEC_APTFIFO}
...
echo "custatus:8:88.8888:Installing core Debian utilities..." >/REAL_ROOT/${DEBEXEC_APTFIFO}
install_deps --and-package \
    libc-bin \
    debconf \
    diffutils \
